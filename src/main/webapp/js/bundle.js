...
var _employeeService = __webpack_require__(4);
...
var DepartmentService = function (_MainService) {
    ...
    function DepartmentService() {
        ...
        return _possibleConstructorReturn(this, (DepartmentService.__proto__ || Object.getPrototypeOf(DepartmentService)).apply(this, arguments));
    }
    ...
    _createClass(DepartmentService, [{
        ...
        value: function viewSaveForm() {
            ...
            function drawSaveForm(result) {
                ...
                $(function () {
                    department.controller.doAction("department/save");
                });
            }
        }
    }, {
        key: "save",
        value: function save() {
            var getAjaxOptions = _get(DepartmentService.prototype.__proto__ || Object.getPrototypeOf(DepartmentService.prototype), "getAjaxOptions", this);
            var doAjax = _get(DepartmentService.prototype.__proto__ || Object.getPrototypeOf(DepartmentService.prototype), "doAjax", this);

            var getDepartmentJson = function getDepartmentJson() {
            ...
            $('#departmentSaveForm').validate({
                ...
                submitHandler: function submitHandler() {
                    var departmentJson = getDepartmentJson();
