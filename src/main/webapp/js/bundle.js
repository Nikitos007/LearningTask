...
var _employeeService = __webpack_require__(6);
...
var _departmentValidation = __webpack_require__(4);

var _departmentValidation2 = _interopRequireDefault(_departmentValidation);
...
var DepartmentService = function (_MainService) {
    ...
    function DepartmentService() {
        ...
        _this.validator = new _departmentValidation2.default();
        _this.departmentValidator = _this.validator.validateDepartment;
    ...
    _createClass(DepartmentService, [{
        ...
        value: function viewSaveForm() {
            ...
            var DEPARTMENT_SAVE_FORM = 'departmentSaveForm';
...
var _mainValidation = __webpack_require__(5);

var _mainValidation2 = _interopRequireDefault(_mainValidation);
...
var DepartmentValidation = function (_MainValidation) {
    _inherits(DepartmentValidation, _MainValidation);

    function DepartmentValidation() {
        _classCallCheck(this, DepartmentValidation);

        var _this = _possibleConstructorReturn(this, (DepartmentValidation.__proto__ || Object.getPrototypeOf(DepartmentValidation)).call(this));

        _this.checkUniqueName();
        return _this;
    }

    _createClass(DepartmentValidation, [{
        key: "getDepartmentJson",
        value: function getDepartmentJson() {
        ...
        value: function checkUniqueName() {
            var checkUnique = _get(DepartmentValidation.prototype.__proto__ || Object.getPrototypeOf(DepartmentValidation.prototype), "checkUnique", this);
            var departmentJson = this.getDepartmentJson;
        ...
        key: "validateDepartment",
        value: function validateDepartment(saveDepartment, formId) {
            $('#' + formId).validate({
                rules: {
                    departmentName: {
                        required: true,
...
var mainValidation = function () {
    function mainValidation() {
        _classCallCheck(this, mainValidation);
    ...
    _createClass(mainValidation, [{
        ...
        key: "checkUnique",
        value: function checkUnique(url, data) {
            var isUnique = void 0;
            $.ajax({
                async: false,
                type: "POST",
...
exports.default = mainValidation;
...
var _employeeValidation = __webpack_require__(7);

var _employeeValidation2 = _interopRequireDefault(_employeeValidation);
...
var EmployeeService = function (_MainService) {
    ...
    function EmployeeService() {
        ...
        var _this = _possibleConstructorReturn(this, (EmployeeService.__proto__ || Object.getPrototypeOf(EmployeeService)).call(this));

        _this.validator = new _employeeValidation2.default();
        _this.employeeValidator = _this.validator.validateEmployee;
        _this.viewSaveForm = _this.viewSaveForm.bind(_this);
        _this.save = _this.save.bind(_this);
        return _this;
    }
    ...
    _createClass(EmployeeService, [{
        ...
        value: function viewSaveForm() {
            ...
            var validator = this.employeeValidator;
            var saveEmployee = this.save;
            var EMPLOYEE_SAVE_FORM = 'employeeSaveForm';

            function drawSaveForm(result) {
                var departmentJson = result.department;
                var saveForm = $('<form></form>').attr({ class: "form-horizontal col-lg-offset-2", id: EMPLOYEE_SAVE_FORM });
        ...
        value: function save() {
            ...
            var options = _get(EmployeeService.prototype.__proto__ || Object.getPrototypeOf(EmployeeService.prototype), "getAjaxOptions", this).call(this, "POST", "employee/save", this.validator.getEmployeeToSave());
...
var employeeToSave = void 0;
var departmentOfEmployee = void 0;

var EmployeeValidation = function (_MainValidation) {
    _inherits(EmployeeValidation, _MainValidation);

    function EmployeeValidation() {
        _classCallCheck(this, EmployeeValidation);

        var _this = _possibleConstructorReturn(this, (EmployeeValidation.__proto__ || Object.getPrototypeOf(EmployeeValidation)).call(this));

        _this.checkUniqueEmail();
        return _this;
    }

    _createClass(EmployeeValidation, [{
        key: 'getEmployeeJson',
        value: function getEmployeeJson() {
        ...
        key: 'checkUniqueEmail',
        value: function checkUniqueEmail() {
            var checkUnique = _get(EmployeeValidation.prototype.__proto__ || Object.getPrototypeOf(EmployeeValidation.prototype), 'checkUnique', this);
            var employeeJson = this.getEmployeeJson;
        ...
        key: 'getEmployeeToSave',
        value: function getEmployeeToSave() {
            return employeeToSave;
        }
    }, {
        key: 'getDepartmentOfEmployee',
        value: function getDepartmentOfEmployee() {
            return departmentOfEmployee;
        }
    }, {
        key: 'validateEmployee',
        value: function validateEmployee(saveEmployee, formId) {
            $('#' + formId).validate({
                rules: {
                    name: {
                        required: true,
...
exports.default = EmployeeValidation;
